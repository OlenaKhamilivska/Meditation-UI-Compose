...
val Green40 = Color(0xFF15B411)

val LightOrange1 = Color(0xFFFB8C00)
val LightOrange2 = Color(0xFFCA7A14)
val LightOrange3 = Color(0xFFE0C29C)

val LightRed1 = Color(0xFFE53935)
val LightRed2 = Color(0xFFD51813)
val LightRed3 = Color(0xFFF3A9A7)
